...
The cloudrun service is mapped to a K8S service with the same name - this can be used as a destination in Gateway or
VirtualService using a different name or load balancing multiple CloudRun regions.
