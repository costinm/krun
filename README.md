...
kubectl apply -k github.com/costinm/krun/manifests/
...
curl https://raw.githubusercontent.com/costinm/krun/main/manifests/google-service-account-template.yaml | envsubst | kubectl apply -f -
...
curl https://raw.githubusercontent.com/costinm/krun/main/manifests/sni-service-template.yaml | SNI_GATE_IP=${SNI_GATE_IP} K_SERVICE=${K_SERVICE} envsubst  | kubectl apply -f -
...
kubectl -n fortio apply -f https://raw.githubusercontent.com/costinm/krun/main/samples/fortio/in-cluster.yaml
